...
export default {
  ...
  props: {
    ...
    enableAutoTranslateText: { type: Boolean, default: false },
    autoTranslateLanguage: { type: String, default: "en" }
  },
  watch: {},
  mounted() {
    var that = this;
    ...
    this.rtcmConnection.onmessage = function(event) {
      ...
      console.log(event.orignal);
      that.$emit("append-translated-text", event.data);
    };
  },
  methods: {
    join() {
